...
import { initializeDatabase } from './main/services/databaseInitializer';
...
const initializeApp = () => {
  ...
  app.whenReady().then(async () => {
    ...
    if (!dbInitResult.ok) {
      console.error('Failed to initialize database:', dbInitResult.error.message);
      console.log('Continuing with app startup...');
    } else {
      const { directory, databasePath, wasCreated } = dbInitResult.value;
      console.log(`Database ${wasCreated ? 'created' : 'exists'} at: ${databasePath}`);
    }
